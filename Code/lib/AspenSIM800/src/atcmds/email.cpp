...
// ============================================================
void SIM800::mailBearerID(CmdType type, const char* str) {
    outBuilder(type, str, P("EMAILCID"));
    print(ioBuffer);
}

// ============================================================
void SIM800::mailTimeout(CmdType type, const char* str) {
    outBuilder(type, str, P("EMAILTO"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smtpServer(CmdType type, const char* str) {
    outBuilder(type, str, P("SMTPSRV"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smtpAuth(CmdType type, const char* str) {
    outBuilder(type, str, P("SMTPAUTH"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smtpFrom(CmdType type, const char* str) {
    outBuilder(type, str, P("SMTPFROM"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smtpTo(CmdType type, const char* str) {
    outBuilder(type, str, P("SMTPRCPT"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smtpSubject(CmdType type, const char* str) {
    outBuilder(type, str, P("SMTPSUB"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smtpBody(CmdType type, const char* str) {
    outBuilder(type, str, P("SMTPBODY"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smtpFile(CmdType type, const char* str) {
...
// ============================================================
void SIM800::smtpFilesend(CmdType type, const char* str) {
    outBuilder(type, str, P("SMTPFT"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smtpCharset(CmdType type, const char* str) {
    outBuilder(type, str, P("SMTPCS"));
    print(ioBuffer);
}

// ============================================================
void SIM800::popCfg(CmdType type, const char* str) {
...
// ============================================================
void SIM800::popMailSize(CmdType type, const char* str) {
    outBuilder(type, str, P("POP3LIST"));
    print(ioBuffer);
}

// ============================================================
void SIM800::popMailUID(CmdType type, const char* str) {
    outBuilder(type, str, P("POP3UIDL"));
    print(ioBuffer);
}

// ============================================================
void SIM800::popMultiGet(CmdType type, const char* str) {
    outBuilder(type, str, P("POP3CMD"));
    print(ioBuffer);
}

// ============================================================
void SIM800::popMultiRead(CmdType type, const char* str) {
    outBuilder(type, str, P("POP3READ"));
    print(ioBuffer);
}

// ============================================================
void SIM800::popMarkDel(CmdType type, const char* str) {
