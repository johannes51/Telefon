...
// ============================================================
void SIM800::smsDel(CmdType type, const char* str) {
    outBuilder(type, str, P("CMGD"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsFormat(CmdType type, const char* str) {
    outBuilder(type, str, P("CMGF"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsList(CmdType type, const char* str) {
    outBuilder(type, str, P("CMGL"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsRead(CmdType type, const char* str) {
...
// ============================================================
void SIM800::smsSendFromStore(CmdType type, const char* str) {
    outBuilder(type, str, P("CMSS"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsNotifyNew(CmdType type, const char* str) {
    outBuilder(type, str, P("CNMI"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsStorage(CmdType type, const char* str) {
    outBuilder(type, str, P("CPMS"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsRestoreCfg(CmdType type, const char* str) {
    outBuilder(type, str, P("CRES"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsSaveCfg(CmdType type, const char* str) {
    outBuilder(type, str, P("CSAS"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsCenterAddress(CmdType type, const char* str) {
    outBuilder(type, str, P("CSCA"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsCellCast(CmdType type, const char* str) {
    outBuilder(type, str, P("CSCB"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsGetParams(CmdType type, const char* str) {
    outBuilder(type, str, P("CSDH"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsSetParams(CmdType type, const char* str) {
    outBuilder(type, str, P("CSMP"));
    print(ioBuffer);
}

// ============================================================
void SIM800::smsService(CmdType type, const char* str) {
