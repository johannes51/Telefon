...
public:
    ...
    /* ATD        29 */    void originCall          (const char*);
    /* ATDL       34 */    void redialLastAddr      ();
    /* ATE        35 */    void setCmdEcho          (const char*);
    /* ATH        35 */    void endCall             ();
    /* ATI        35 */    void getDeviceID         ();
    /* ATL        36 */    void monSpeakerVol       (const char*);
    /* ATM        36 */    void monSpeakerMode      (const char*);
    /* +++        36 */    void toCmdMode           ();
    /* ATO        37 */    void toDataMode          ();
    /* ATP        37 */    void pulseDialing        ();
    /* ATQ        38 */    void setResultMode       (const char*);
    /* ATS0       38 */    void autoAnswerAfter     (CmdType, const char* = "");
    /* ATS3       39 */    void cmdlnEndChar        ();
    /* ATS4       39 */    void cmdlnFormatChar     ();
    /* ATS5       40 */    void cmdlnEditChar       ();
    /* ATS6       41 */    void blindDialPause      (CmdType, const char* = "");
    /* ATS7       41 */    void connWaitTime        (CmdType, const char* = "");
    /* ATS8       42 */    void commaWaitTime       (CmdType, const char* = "");
    /* ATS10      42 */    void carrierLostDelay    (CmdType, const char* = "");
    /* ATT        43 */    void toneDialing         ();
    /* ATV        43 */    void setResponseFormat   (const char*);
    /* ATX        44 */    void setCallMonitor      (const char*);
    /* ATZ        45 */    void userReset           ();
    /* AT&C       45 */    void setDcdMode          (const char*);
    /* AT&D       46 */    void setDtrMode          (const char*);
    ...
    /* AT+ICF     52 */    void serialFraming       (CmdType, const char* = "");
    /* AT+IFC     53 */    void serialFlowCtrl      (CmdType, const char* = "");
    /* AT+IPR     54 */    void serialBauds         (CmdType, const char* = "");
