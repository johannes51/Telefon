...
// ============================================================
void SIM800::originCall(const char* str) {
...
// ============================================================
void SIM800::setCmdEcho(const char* str) {
...
// ============================================================
void SIM800::monSpeakerVol(const char* str) {
    outBuilder(EXE, str, P("ATL"), false);
    print(ioBuffer);
}

// ============================================================
void SIM800::monSpeakerMode(const char* str) {
...
// ============================================================
void SIM800::setResultMode(const char* str) {
    outBuilder(EXE, str, P("ATQ"), false);
    print(ioBuffer);
}

// ============================================================
void SIM800::autoAnswerAfter(CmdType type, const char* str) {
...
// ============================================================
void SIM800::blindDialPause(CmdType type, const char* str) {
    outBuilder(type, str, P("ATS6"), false);
    print(ioBuffer);
}

// ============================================================
void SIM800::connWaitTime(CmdType type, const char* str) {
    outBuilder(type, str, P("ATS7"), false);
    print(ioBuffer);
}

// ============================================================
void SIM800::commaWaitTime(CmdType type, const char* str) {
    outBuilder(type, str, P("ATS8"), false);
    print(ioBuffer);
}

// ============================================================
void SIM800::carrierLostDelay(CmdType type, const char* str) {
...
// ============================================================
void SIM800::setResponseFormat(const char* str) {
    outBuilder(EXE, str, P("ATV"), false);
    print(ioBuffer);
}

// ============================================================
void SIM800::setCallMonitor(const char* str) {
...
// ============================================================
void SIM800::setDcdMode(const char* str) {
    outBuilder(EXE, str, P("AT&C"), false);
    print(ioBuffer);
}

// ============================================================
void SIM800::setDtrMode(const char* str) {
...
// ============================================================
void SIM800::serialFraming(CmdType type, const char* str) {
    outBuilder(type, str, P("ICF"));
    print(ioBuffer);
}

// ============================================================
void SIM800::serialFlowCtrl(CmdType type, const char* str) {
    outBuilder(type, str, P("IFC"));
    print(ioBuffer);
}

// ============================================================
void SIM800::serialBauds(CmdType type, const char* str) {
