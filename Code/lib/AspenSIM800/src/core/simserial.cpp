...
// ============================================================
void SIM800::end() {                                            // Closes SoftwareSerial.
    simCom.end();
}


// ============================================================
void SIM800::write(const char* out) {                                 // This method accepts a character array as an input.
...
// ============================================================
void SIM800::print(const char* out) {                                 // This method accepts a character array as an input.
    simCom.print(out);                                          // Let SoftwareSerial do the actual hard work of banging the outgoing cmd string bit-by-bit out to the SIM800 chip.
