...
// ============================================================
bool SIM800::reply(const char* str) {                                     // Checks if the reply received from the SIM800 module contains the string provided by the user.
...
// ============================================================
void SIM800::outBuilder(CmdType type, const char * param, const char * cmd, bool b) {     // Builds the outgoing AT command which gets sent to the SIM800 module.
